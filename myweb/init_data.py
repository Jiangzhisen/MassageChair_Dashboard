...
def create_customers():
    # 創建客戶資料
    Customer.objects.create(customerid='C001', customername='張三', customergender='男', customerprofession='學生', customerphone='0912345678', customeremail='example1@gmail.com')
    Customer.objects.create(customerid='C002', customername='李四', customergender='女', customerprofession='銀行員', customerphone='0923456789', customeremail='example2@gmail.com')
    Customer.objects.create(customerid='C003', customername='王五', customergender='男', customerprofession='教師', customerphone='0934567890', customeremail='example3@gmail.com')
    Customer.objects.create(customerid='C004', customername='陳六', customergender='女', customerprofession='護士', customerphone='0945678901', customeremail='example4@gmail.com')
    Customer.objects.create(customerid='C005', customername='張七', customergender='男', customerprofession='工程師', customerphone='0956789012', customeremail='example5@gmail.com')
    Customer.objects.create(customerid='C006', customername='李八', customergender='女', customerprofession='行銷人員', customerphone='0967890123', customeremail='example6@gmail.com')
    Customer.objects.create(customerid='C007', customername='王九', customergender='男', customerprofession='設計師', customerphone='0978901234', customeremail='example7@gmail.com')
    Customer.objects.create(customerid='C008', customername='陳十', customergender='女', customerprofession='律師', customerphone='0989012345', customeremail='example8@gmail.com')
    Customer.objects.create(customerid='C009', customername='張十一', customergender='男', customerprofession='教授', customerphone='0990123456', customeremail='example9@gmail.com')
    Customer.objects.create(customerid='C010', customername='李十二', customergender='女', customerprofession='軟體工程師', customerphone='0901234567', customeremail='example10@gmail.com')
    Customer.objects.create(customerid='C021', customername='陳二十一', customergender='男', customerprofession='記者', customerphone='0912345678', customeremail='example21@gmail.com')
    Customer.objects.create(customerid='C022', customername='王二十二', customergender='女', customerprofession='警察', customerphone='0923456789', customeremail='example22@gmail.com')
    Customer.objects.create(customerid='C023', customername='張二十三', customergender='男', customerprofession='建築師', customerphone='0934567890', customeremail='example23@gmail.com')
    Customer.objects.create(customerid='C024', customername='李二十四', customergender='女', customerprofession='工程師', customerphone='0945678901', customeremail='example24@gmail.com')
    Customer.objects.create(customerid='C025', customername='王二十五', customergender='男', customerprofession='教師', customerphone='0956789012', customeremail='example25@gmail.com')
    Customer.objects.create(customerid='C026', customername='陳二十六', customergender='女', customerprofession='專案經理', customerphone='0967890123', customeremail='example26@gmail.com')
    Customer.objects.create(customerid='C027', customername='張二十七', customergender='男', customerprofession='銷售', customerphone='0978901234', customeremail='example27@gmail.com')
    Customer.objects.create(customerid='C028', customername='李二十八', customergender='女', customerprofession='護理師', customerphone='0989012345', customeremail='example28@gmail.com')
    Customer.objects.create(customerid='C029', customername='王二十九', customergender='男', customerprofession='會計師', customerphone='0990123456', customeremail='example29@gmail.com')
    Customer.objects.create(customerid='C030', customername='陳三十', customergender='女', customerprofession='行政人員', customerphone='0901234567', customeremail='example30@gmail.com') 
...
def create_massagechairusage():
    # 創建公共按摩椅使用狀態資料
    MassageChairUsage.objects.create(massagerid='M001', totaltime=30, starttime='2022-06-01', endtime='2022-06-01')
    MassageChairUsage.objects.create(massagerid='M001', totaltime=30, starttime='2022-06-01', endtime='2022-06-01')
    MassageChairUsage.objects.create(massagerid='M001', totaltime=45, starttime='2022-06-02', endtime='2022-06-02')
    MassageChairUsage.objects.create(massagerid='M002', totaltime=20, starttime='2022-06-03', endtime='2022-06-03')
    MassageChairUsage.objects.create(massagerid='M003', totaltime=0, starttime='2022-06-04', endtime='2022-06-04')
    MassageChairUsage.objects.create(massagerid='M004', totaltime=60, starttime='2022-06-05', endtime='2022-06-05')
    MassageChairUsage.objects.create(massagerid='M004', totaltime=15, starttime='2022-06-06', endtime='2022-06-06')
    MassageChairUsage.objects.create(massagerid='M004', totaltime=30, starttime='2022-06-07', endtime='2022-06-07')
    MassageChairUsage.objects.create(massagerid='M005', totaltime=40, starttime='2022-06-08', endtime='2022-06-08')
    MassageChairUsage.objects.create(massagerid='M005', totaltime=10, starttime='2022-06-09', endtime='2022-06-09')
    MassageChairUsage.objects.create(massagerid='M005', totaltime=20, starttime='2022-06-10', endtime='2022-06-10')
...
def create_salesactivity():
    # 創建銷售活動資料
    SalesActivity.objects.create(salesactid='A001', salesacttype='透過公共按摩椅或到店試坐', salesactremark='贈送虛擬按摩券或填寫意見回饋')
    SalesActivity.objects.create(salesactid='A002', salesacttype='邀請家人來店試坐按摩椅', salesactremark='贈送虛擬按摩券給適用人及推薦人')
    SalesActivity.objects.create(salesactid='A003', salesacttype='銷售促推', salesactremark='推送產品資訊、新產品介紹、確保多來幾次')
    SalesActivity.objects.create(salesactid='A004', salesacttype='決戰', salesactremark='送出優惠方案，期限結束即敗戰')
