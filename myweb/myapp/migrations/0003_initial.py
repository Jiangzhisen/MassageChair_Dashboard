...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("myapp", "0002_delete_branch_delete_customer_delete_employee_and_more"),
    ]
    ...
    operations = [
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                fields=("purchaseid", "modelid"), name="unique_purchase_detail"
            ),
        ),
        migrations.AddConstraint(
            model_name="orderdetail",
            constraint=models.UniqueConstraint(
                fields=("orderid", "productid"), name="unique_order_detail"
            ),
        ),
    ]
